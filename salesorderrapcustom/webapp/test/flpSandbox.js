		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Custom Sales Order",
									"targetURL": "#salesorderrapsalesorderrapcustom-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"salesorderrapsalesorderrapcustom-display": {
								"semanticObject": "salesorderrapsalesorderrapcustom",
								"action": "display",
								"description": "An SAP Fiori Sales Order Custom application.",
								"title": "Custom Sales Order",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sales.order.rap.salesorderrapcustom",
									"url": sap.ui.require.toUrl("sales/order/rap/salesorderrapcustom")
								}
							}
						}
					}
